...
MissionCondition1 = [ 
 "WIN", { [Escape_trigger, "east", "", "< 1"] call dzn_fnc_ccUnits && [Escape_trigger_2, "east", "", "> 0"] call dzn_fnc_ccUnits && !isNil "dzn_dynai_initialized" && { dzn_dynai_initialized } && triggerActivated(Fort_destroyed) }, 
 "All objectives done"
];
